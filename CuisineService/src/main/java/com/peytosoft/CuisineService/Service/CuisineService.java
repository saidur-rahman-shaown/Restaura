...
public class CuisineService {
	...
	private final String FOLDER_PATH="C:\\Users\\DELL\\Documents\\myFiles\\cuisines\\";
	...
	public ResponseEntity<Integer> addCuisine(CuisineDto cuisineDto, Integer restaurantId) {
		...
		//String status = callRestaurant.checkStatus(restaurantId).getBody();
			...
			Cuisine cuisine = cuisineDao.save(Cuisine.builder()
			...
			return new ResponseEntity<>(cuisine.getId(),HttpStatus.CREATED);
